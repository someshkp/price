...
export const getAllcategory = () => {
    return async dispatch => {
        ...
        const res = await axios.get(`https://git.heroku.com/inventorymangementapp.git/category/getcategory`);
        console.log(res);
        if (res.status === 200) {
...
export const addCategory = (form) => {
    return async dispatch => {
        ...
        try {
            const res = await axios.post(`https://git.heroku.com/inventorymangementapp.git/category/create`, form);
            if (res.status === 201) {
                dispatch({
...
export const updateCategories = (form) => {
    return async dispatch => {
        ...
        const res = await axios.post(`https://git.heroku.com/inventorymangementapp.git/category/update`, form);
        if (res.status === 201) {
...
export const deleteCategories = (ids) => {
    return async dispatch => {
        ...
        const res = await axios.post(`https://git.heroku.com/inventorymangementapp.git/category/delete`, {
            payload: {
                ids
            }
        });
